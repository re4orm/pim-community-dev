...
class ValueNormalizer implements NormalizerInterface, SerializerAwareInterface
{
    ...
    public function __construct(CachedObjectRepositoryInterface $attributeRepository, CachedObjectRepositoryInterface $attributeOptionRepository, int $precision = 4)
    {
